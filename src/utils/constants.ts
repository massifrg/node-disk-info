...
export class Constants {
  ...
  public static readonly WINDOWS_COMMAND: string =
    "Get-WmiObject -Class Win32_LogicalDisk | Select-Object Caption, FreeSpace, Size, VolumeSerialNumber, Description | Format-List";
  /**
